...
public interface ReleaseVideoMapper {
     ...
     * @mbggenerated Sun Sep 01 01:31:17 CEST 2013
     */
    int updateByExampleSelective(@Param("record") ReleaseVideo record, @Param("example") ReleaseVideoExample example);
     ...
     * @mbggenerated Sun Sep 01 01:31:17 CEST 2013
     */
    int updateByExample(@Param("record") ReleaseVideo record, @Param("example") ReleaseVideoExample example);
