...
public class InterfacciaGrafica extends JFrame {
	...
	private GraficPublisher publisher;
	...
	private OpzioniSms optSms;

	private OpzioniRubrica optRub;
	...
	public void inizia() {
		...
		publisher = new GraficPublisher();
		language = publisher.getLanguage();
	...
	private void inizializzaPannelli() {
		...
		JLabel titolo = new JLabel(language.getText("27"), JLabel.CENTER);
		...
		pannelloSms.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), language.getText("20"), 2, 0));
		...
		pannelloRubrica.setBorder(BorderFactory.createTitledBorder(BorderFactory.createEtchedBorder(), language.getText("21"), 2, 0));
	 ...
	 * 
	 */
	public GraficPublisher getGraficPublisher() {
	 ...
	 * @return
	 */
	public OpzioniSms getOpzioniSms() {
		return this.optSms;
	}
	/**
	 * @return
	 */
	public OpzioniRubrica getOpzioniRubrica() {
		return this.optRub;
	}
