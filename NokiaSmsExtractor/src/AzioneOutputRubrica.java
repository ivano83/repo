 ...
 * @author Ivano
 *
 * AzioneOutputRubrica. Finestra output rubrica
 */
public class AzioneOutputRubrica implements ActionListener {

	private JFileChooser fc = new JFileChooser();
	private InterfacciaGrafica interfaccia;
	private Language language;

	public AzioneOutputRubrica(InterfacciaGrafica i) {
		this.interfaccia = i;
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (scelta==JFileChooser.APPROVE_OPTION) {
			...
			if(n==0) {
				...
				interfaccia.insertTextArea(language.getText("25")+": "+ fileOut.getPath() +"\n");
				interfaccia.setTestoOutputRubrica(fileOut.getPath());
			}
		}
