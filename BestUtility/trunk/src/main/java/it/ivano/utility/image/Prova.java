...
//		int[] xy = ir.imageWxH("C:\\test1.jpg");
//		System.out.println(xy[0]);
//        ir.compressImage("C:\\test1.jpg", "C:\\Users\\i.fiorini\\Downloads\\abc.jpg", 200, 200); 
	
		
		/**
		// Retrieve jpg image to be compressed
        RenderedImage rendImage = ImageIO.read(new File("C:\\test1.jpg"));
        ...
        // Prepare output file
        ImageOutputStream ios = ImageIO.createImageOutputStream(new File("C:\\Users\\i.fiorini\\Downloads\\abcd.jpg"));
        ...
        */
		...
		String fileIn = "C:\\test1.jpg";
		File inFile = new File(fileIn);
		String fileOut = "C:\\Users\\ivano\\Downloads\\abcd.jpg";
		
		JpegCompression j = new JpegCompression();
		j.compressAndSave(inFile, fileOut, MaxImageSize.MAX_200K, MaxImageDimension.MAX_800);
        ...
        System.out.println("in: "+(new File(fileIn)).length());
        System.out.println("out: "+outFile.length());
